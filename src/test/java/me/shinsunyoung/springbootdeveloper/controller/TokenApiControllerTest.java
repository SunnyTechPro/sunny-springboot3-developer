...
public class TokenApiControllerTest {
    ...
    /*
     given:
        create
            test user
            a refresh token using jjwt library and then save it to database
            a request Object that includes the refresh token in token api request body
     */
    ...
    /*
     when:
        send add token api request
        request type: JSON
        request body: the request Object that is made at the given level
     */
    ...
    /*
     then:
        check
            if the response code is 201 or not
            response access token is not empty
     */
        resultActions
